      ...
      <MDBContainer className="text-center text-md-left">
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          ...
          <MDBCol md="2" lg="2" xl="2" className="mx-auto mt-3">
            ...
            <p>
              <a href="https://github.com/DurveshYadav">GitHub</a>
            </p>
            <p>
              <a href="https://www.linkedin.com/in/durvesh-yadav-a5a138141/">Linkedin</a>
            </p>
          ...
          <MDBCol md="4" lg="3" xl="3" className="mx-auto mt-3">
            ...
            <p>
              <i className="fa fa-envelope mr-3" /> ydurveshyadav206@gmail.com
            </p>
            <p>
              <i className="fa fa-phone mr-3" /> +918178950194
            </p>
            <p>
              <i className="fa fa-home mr-3" /> BHU Varansi, UP
            </p>
          </MDBCol>
        </MDBRow>
        <hr />
          ...
          <MDBCol md="4" lg="4" className="ml-lg-0">
            <div className="text-center text-md-right">
              ...
              <li className="list-inline-item">
                  <a className="btn-floating btn-sm rgba-white-slight mx-1" href="https://github.com/DurveshYadav">
                    <i className="fab fa-github" />
                  </a>
                </li>
                <li className="list-inline-item">
                  <a className="btn-floating btn-sm rgba-white-slight mx-1" href='https://www.linkedin.com/in/durvesh-yadav-a5a138141/'>
